// =============================================================================
// Name        : simulation_polishing_node.cpp
// Author      : Hélio Ochoa
// Description :
// =============================================================================
...
int main(int argc, char** argv) {
    ...
    ros::init(argc, argv, "simulation_polishing_node");
    ...
    pose_i = panda.robotPose(O_T_EE_i);
        ...
        switch (flag_pattern) { ////////////////////////////////////////////////////
            ...
            case PATTERN:
                ...
                if (count < n_pattern-1){
                    ...
                    flag_pattern = MOVEUP;
                    O_T_EE_i = panda.O_T_EE;
                    pose_i = panda.robotPose(O_T_EE_i);  // get current pose
                    pi << pose_i[0], pose_i[1], pose_i[2];
                    pf << pi + delta_up;
                    t = 0;  // reset the time
                }

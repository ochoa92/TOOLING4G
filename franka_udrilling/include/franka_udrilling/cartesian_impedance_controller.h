...
class CartesianImpedanceController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  double Kpx, Kpy, Kpz, Kox, Koy, Koz, Dpx, Dpy, Dpz, Dox, Doy, Doz, Ipx, Ipy, Ipz, Iox, Ioy, Ioz, Kp_nullspace;
  ...
  Eigen::Vector3d F_EE_d_;
  Eigen::Matrix3d Kf; // proporcional force gain
  Eigen::Matrix<double, 6, 6> cartesian_Kf_;

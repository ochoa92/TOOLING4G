...
int main(int argc, char** argv) {
  ...
  ros::init(argc, argv, "curved_surface_node");
  ...
  pattern_path = "/home/helio/catkin_ws/src/franka_ros/franka_polishing/mold_data/pattern";
  ...
  if(pattern_file.is_open()){
    while(pattern_file >> time >> px >> py >> pz >> qx >> qy >> qz >> qw >> Fx_EE >> Fy_EE >> Fz_EE >> Fx_O >> Fy_O >> Fz_O){
  ...
  mold_path = "/home/helio/catkin_ws/src/franka_ros/franka_polishing/mold_data/mold_points";
  ...
  double x, y, z;
  Eigen::MatrixXd P;
  ws_path = "/home/helio/catkin_ws/src/franka_ros/franka_polishing/mold_data/mold_workspace";

...
#include <franka_polishing/compliance_paramConfig.h>
...
class PolishingController : public controller_interface::MultiInterfaceController<franka_hw::FrankaModelInterface,
    ...
    private:
        ...
        // Dynamic reconfigure
        std::unique_ptr<dynamic_reconfigure::Server<franka_polishing::compliance_paramConfig>> dynamic_server_compliance_param_;
